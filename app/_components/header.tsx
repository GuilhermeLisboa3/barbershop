...

            {
              data?.user ? (
                <div className="flex justify-between px-5 py-6 items-center">
                  ...
                  <Button variant='secondary' size='icon' onClick={handlerLogoutClick}><LogOutIcon/></Button>
                </div>
              ) : (
                <div className="flex flex-col px-5 py-6 gap-3">
                  ...
                  <Button variant='secondary' className="w-full justify-start" onClick={handlerLoginClick}>
